...
-   src/train.py\
    Target-domain evaluation and tuning logic.

-   src/utils.py\
    Utility functions (seed control, parameter handling).
...
-   --seeds: random seeds\
-   --meta_scale: meta objective scaling\
-   --tau: temperature for permutation\
-   --lr: learning rate
